...
public class DepositoSuministroTest {
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearElNombreDEPOSITO_SUMINISTRO() throws FueraDeMatriz{
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearCostoDeMineral100() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearCostoDeGas0() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
		Integer costoGas = 0;
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearTiempoDeConstruccion6() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearVida500() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
		Integer vida = 500;
	...
	@Test
	public void testCrearDepositoSuministroDeberiaSetearEscudo0() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
		Integer escudo =0;
	...
	@Test
	public void testCrearDepositoSuministroDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		DepositoSuministro unDepositoSuministro = new DepositoSuministro(new Posicion(2,2));
