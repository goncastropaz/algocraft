...
public class PuertoEstelarProtossTest {
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearElNombrePUERTO_ESTELAR_PROTOSS() throws FueraDeMatriz{
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearCostoDeMineral150() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearCostoDeGas150() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearTiempoDeConstruccion10() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearVida600() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
		Integer vida = 600;
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaSetearEscudo600() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
		Integer escudo =600;
	...
	@Test
	public void testCrearPuertoEstelarProtossDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		PuertoEstelarProtoss unPuertoEstelarProtoss = new PuertoEstelarProtoss(new Posicion(2,2));
