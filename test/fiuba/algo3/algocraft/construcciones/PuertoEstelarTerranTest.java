...
public class PuertoEstelarTerranTest {
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearElNombrePUERTO_ESTELAR_TERRAN() throws FueraDeMatriz{
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearCostoDeMineral150() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearCostoDeGas100() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearTiempoDeConstruccion10() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearVida1300() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
		Integer vida = 1300;
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaSetearEscudo0() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
		Integer escudo =0;
	...
	@Test
	public void testCrearPuertoEstelarTerranDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		PuertoEstelarTerran unPuertoEstelarTerran = new PuertoEstelarTerran(new Posicion(2,2));
