...
public class ArchivoTemplarioTest {
	...
	@Test
	public void testCrearArchivoTemplariosDeberiaSetearElNombreARCHIVO_TEMPLARIO() throws FueraDeMatriz{
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaSetearCostoDeMineral150() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaSetearCostoDeGas200() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaSetearTiempoDeConstruccion9() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaSetearVida500() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
		Integer vida = 500;
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaSetearEscudo500() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
		Integer escudo =500;
	...
	@Test
	public void testCrearArchivosTemplariosDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		ArchivoTemplario unArchivosTemplario = new ArchivoTemplario(new Posicion(2,2));
