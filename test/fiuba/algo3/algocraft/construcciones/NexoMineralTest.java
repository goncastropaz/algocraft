...
public class NexoMineralTest {
	@Test
	public void testCrearNexoMineralDeberiaSetearElNombreNEXO_MINERAL() throws FueraDeMatriz{
	...
	@Test
	public void testCrearNexoMineralDeberiaSetearCostoDeMineral50() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
	...
	@Test
	public void testCrearNexoMineralDeberiaSetearCostoDeGas0() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
		Integer costoGas = 0;
	...
	@Test
	public void testCrearNexoMineralDeberiaSetearTiempoDeConstruccion4() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
	...
	@Test
	public void testCrearNexoMineralDeberiaSetearVida250() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
		Integer vida = 250;
	...
	@Test
	public void testCrearNexoMineralDeberiaSetearEscudo250() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
		Integer escudo =250;
	...
	@Test
	public void testCrearNexoMineralDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		NexoMineral unNexoMineral = new NexoMineral(new Posicion(2,2));
