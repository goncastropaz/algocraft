...
public class NaveCienciaTest {
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearElNombreNaveCiencia() throws FueraDeMatriz{
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearCostoDeMineral100() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearCostoDeGas225() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearTiempoDeConstruccion10() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearVida200() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
		Integer vida = 200;
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearEscudo0() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
		Integer escudo =0;
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaSetearVision10() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
		int vision=10;
	...
	@Test
	public void testCrearUnidadNaveCienciaDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
	...
	@Test
	public void testsetUbicacionNaveCienciaDeberiaCambiarLaCeldaDondeEstaUbicada() throws FueraDeMatriz, UnidadTerrestreEnAreaEspacial, CeldaOcupada{
		NaveCiencia unaNaveCiencia = new NaveCiencia(new Posicion(2,2));
