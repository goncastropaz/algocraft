...
public class ZealotTest {
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearElNombreZealot() throws FueraDeMatriz, JugadorInvalido{
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearCostoDeMineral100() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearCostoDeGas0() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearTiempoDeConstruccion4() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearVida100() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
		Integer vida = 100;
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearEscudo60() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
		Integer escudo =60;
	...
	@Test
	public void testCrearUnidadZealotDeberiaSetearVision7() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
		int vision=7;
	...
	@Test
	public void testCrearUnidadZealotDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
	...
	@Test
	public void testsetUbicacionZealotDeberiaCambiarLaCeldaDondeEstaUbicada() throws FueraDeMatriz, UnidadTerrestreEnAreaEspacial, CeldaOcupada, JugadorInvalido{
		Juego nuevoJuego = Juego.getInstance();
		nuevoJuego.empezarJuego();
		Zealot unZealot = new Zealot(new Posicion(2,2));
