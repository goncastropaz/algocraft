...
public class GolliatTest {
	@Test
	public void testCrearUnidadGolliatDeberiaSetearElNombreGolliat() throws FueraDeMatriz{
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearCostoDeMineral100() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearCostoDeGas50() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
		Integer costoGas = 50;
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearTiempoDeConstruccion6() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearVida125() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
		Integer vida = 125;
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearEscudo0() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
		Integer escudo =0;
	...
	@Test
	public void testCrearUnidadGolliatDeberiaSetearVision8() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
		int vision=8;
	...
	@Test
	public void testCrearUnidadGolliatDeberiaGuardarLaCeldaDondeEstaUbicada() throws FueraDeMatriz{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
	...
	@Test
	public void testsetUbicacionGolliatDeberiaCambiarLaCeldaDondeEstaUbicada() throws FueraDeMatriz, UnidadTerrestreEnAreaEspacial, CeldaOcupada{
		Golliat unGolliat = new Golliat(new Posicion(2,2));
