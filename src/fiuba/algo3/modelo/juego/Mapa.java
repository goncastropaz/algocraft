...
public class Mapa {
	...
	public Posicion agregarUnidad(Unidad unidad, Posicion posConstruccion,Jugador jugadorAcual) throws CeldaOcupada{
		...
		for(int i =0; i<posiblesCeldas.size();i++){
			...
			if(unidad.permitidaEnArea(celda)&& celda.desocupada()&& jugadorAcual.tieneVisionDeCelda(celda.getPosicion())){
